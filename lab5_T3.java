...
public class lab5_T3 {
     ...
     */
    public lab5_T3(String subjectCode, String subjectName) {
     ...
     */
    public lab5_T3(String subjectCode, String subjectName, int creditHours,String department) {
        this.subjectCode = subjectCode;
        this.subjectName = subjectName;
    ...
    public static void main(String[] args) {
        ...
        lab5_T3 softwareEngineering = new lab5_T3("SE220", "Software Engineering");
        lab5_T3 computerArchitecture = new lab5_T3("CA230","Computer Architecture", 4, "Electrical Engineering");
        lab5_T3 dataStructure = new lab5_T3("DS210", "Data Structure");
        System.out.println(softwareEngineering);
        System.out.println(computerArchitecture);
        System.out.println(dataStructure);
        System.out.println("Default Department "+ lab5_T3.getDefaultDepartment());
        System.out.println("Default credit hours: "+ lab5_T3.getDefaultCreditHours());
        ...
        try{
            softwareEngineering.setSubjectName(null);
        }catch (IllegalArgumentException e){
            System.out.println("Error setting subject name: " + e.getMessage());
        }

        try {
            softwareEngineering.setSubjectName(" ");
        } catch (IllegalArgumentException e) {
           System.out.println("Error setting subject name: " + e.getMessage());
        }

        softwareEngineering.setSubjectName("Advance Software Engineering");
        System.out.println(softwareEngineering);
    }
}